...
<DIV class=main>
	<DIV class="body body-950">
		...
		<DIV class="container typecho-page-main typecho-post-option typecho-post-area">
			<FORM method=post name=write_post action="<?php echo site_url('admin/add_intelligence_news_action/'.$table.'/');?>">
...
<?php $date;?>
  	...
  	<P>
        ...
        <input size="2" maxlength="2" type="text" name="minute" id="minute" value="<?php echo $time['minute'];?>" />
						...
						<P class=title><INPUT id=title class="text title" name=title></P>
